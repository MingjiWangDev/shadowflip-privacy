...
This Privacy Policy applies to all users who download and use the ShadowFlip: Xiangqi iOS app from the Apple App Store.
...
V1.0.0 of this App does **not** integrate any third-party tracking, analytics, or advertising SDKs and does **not** use App Tracking Transparency (ATT) for tracking purposes.

## 9. Changes to This Policy

We may update this Privacy Policy from time to time. Material changes will be communicated through in-app notifications or App Store description. The updated policy takes effect on the date of the update.
...
- Developer: Mingji Wang

---

© 2025-2026 Mingji Wang. All rights reserved.
